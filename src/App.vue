<template>
  <div
    id="app"
    class="bg-white w-[210mm] min-h-[297mm] mx-auto p-[20mm] shadow-md text-gray-800 print:shadow-none print:mx-0 print:p-0 print:bg-white"
  >
    <!-- LOADING OVERLAY -->
    <div
      v-if="isExporting"
    ...
    >
      <div
        class="bg-white px-6 py-4 rounded-lg shadow text-gray-700 font-medium animate-pulse"
      >
    ...
    <div ref="resume">
      ...
      <div class="flex">
        ...
        <div class="w-1/3 pr-4 bg-gray-200 p-3 print:bg-gray-200">
          ...
          <div class="mb-5">
            <h3
              class="bg-gray-700 text-white px-3 py-1 rounded text-sm uppercase tracking-wide mb-2"
            >
              Contact
            </h3>
            ...
            <div class="flex items-center text-sm mb-1">
              <svg
                ...
                class="w-5 h-5 mr-2 flex-shrink-0 text-gray-800"
                viewBox="0 0 640 640"
              >
                <path
            ...
            <div class="flex items-center text-sm mb-1">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                class="w-5 h-5 mr-2 flex-shrink-0 text-gray-700"
                viewBox="0 0 640 640"
              >
                <path
        ...
        <div class="w-2/3 pl-4">
          ...
          <div class="mb-6">
            ...
            <div class="grid grid-cols-2 gap-2 text-sm">
              ...
              <div>
                <strong>Place of birth:</strong> {{ about.placeOfBirth }}
              </div>
